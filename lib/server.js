...
Server.prototype.accessToken = function(options) {
  return accessToken(options);
}

Server.prototype.userAuthorization = function(options) {
  return userAuthorization(this, options);
}

Server.prototype.userDecision = function(options, verifierFn) {
  // TODO: Make an option to not prepend the transaction loader.
  return [transactionLoader(this, options), userDecision(this, options, verifierFn)];
}
